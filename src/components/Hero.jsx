...
const Hero = () => {
  return (
   ...
   <h1 className="text-2xl md:text-4xl lg:text-4xl font-sm">Hi I&lsquo;m Rifat Rahman</h1>
   <h1 className="text-center md:text-start sm:text-2xl pt-1 text-slate-200">Frontend Webdeveloper</h1>
      ...
      <button className=" hover:text-white cursor-pointer text-slate-300"><span className="text-lg">C</span>ontact Me</button>
